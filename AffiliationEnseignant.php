...
<head>
  <meta charset="UTF-8">
  <title>Affiliation Enseignant</title>
                ...
                <li class="collapsible-header">
                    ...
                    <div class="col s4 center"><strong>Matricule</strong></div>
                     ...
                     <div class="col s4 center"></div>
                        ...
                        <?php
                            $reponse = $bdd ->query('SELECT * FROM enseigne ORDER BY matricule_enseignant DESC');
                            foreach ($reponse as $donnees){
                            	$matricule_enseignant = $donnees['matricule_enseignant'];
                            	$promo = $donnees['id_promo'];

                            	$personnel = $bdd->query('SELECT * FROM enseignant WHERE matricule_enseignant=\'' . $matricule_enseignant. '\' ');
                            	...
                            	foreach ($personnel as $key) {
                            		foreach ($intitule as $rq ) {
                                     ...
                                     <div class="collapsible-header line" tabindex="0">
                                         ...
                                         <div class="col s4 center">'.$key['matricule_enseignant'].'</div>
                                         <div class="col s4 center">'.$rq['intitule'].'</div>
                                         <div class="col s4 center">
                                           <a onclick="return confirm(\'Êtes vous sûr de supprimer?\')" href="SuppAffiliationEns.php?matricule_enseignant='.$matricule_enseignant.'&promo='.$rq['id_promo'].'" 
