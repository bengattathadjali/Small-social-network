...
<head>
  <meta charset="UTF-8">
  <title>Affichage Des Personnels</title>
                ...
                <li class="collapsible-header">
                    ...
                    <div class="col s4 center"><strong>Matricule</strong></div>
                     ...
                     <div class="col s4 center"></div>
                        ...
                        <?php
                            $reponse = $bdd ->query('SELECT nom,prenom,matricule_personnel,email FROM personnel ORDER BY email DESC');
                            foreach ($reponse as $donnees){
                             echo '<ul><li>
                                     <div class="collapsible-header line" tabindex="0">
                                         ...
                                         <div class="col s4 center">'.$donnees['matricule_personnel'].'</div>
                                         <div class="col s4 center">'.$donnees['email'].'</div>
                                         <div class="col s4 center">
                                           <a onclick="return confirm(\'Êtes vous sûr de supprimer?\')" href="TraitementSuppPers.php?matricule_personnel='.$donnees['matricule_personnel'].'" 
