...
<!-- Section Publication -->
	...
	<tr><th>
	 ...
	 <div class="row" >
	    <form class="col s5" action="AjouterPubPers.php" method="POST" enctype="multipart/form-data">
	      <div class="row">
	        <div class="input-field col s12">
	        	<textarea name="contenu"required class="materialize-textarea" placeholder="Ecrivez votre texte"></textarea>
	        </div>
	      </div>
	      <?php 
		    ...
		    <header class="w3-container w3-light-grey">
 			...
 			<h3><?php echo '@'.strtolower($result['nom']).' '.strtolower($result['prenom']);?></h3>
 			 ...
 			 <div class="w3-container">
 			 	...
 			 	<button class="w3-button w3-block w3-red"><a href="SuppPubPers.php?id=<?php echo $id;?>"  onclick="return confirm('Êtes vous sûr de supprimer?')" >Supprimer</a></button>
