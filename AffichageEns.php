...
<head>
  <meta charset="UTF-8">
  <title>Affichage Des Enseignants</title>
                ...
                <li class="collapsible-header">
                    ...
                    <div class="col s4 center"><strong>Matricule</strong></div>
                     ...
                     <div class="col s4 center"></div>
                        ...
                        <?php
                            $reponse = $bdd ->query('SELECT nom,prenom,matricule_enseignant,email FROM enseignant ORDER BY email DESC');
                            foreach ($reponse as $donnees){
                             echo '<ul><li>
                                     <div class="collapsible-header line" tabindex="0">
                                         ...
                                         <div class="col s4 center">'.$donnees['matricule_enseignant'].'</div>
                                         <div class="col s4 center">'.$donnees['email'].'</div>
                                         <div class="col s4 center">
                                           <a onclick="return confirm(\'Êtes vous sûr de supprimer?\')" href="TraitementSuppEns.php?matricule_enseignant='.$donnees['matricule_enseignant'].'" 
